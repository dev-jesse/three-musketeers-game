...
public class GreedyAlgorithm implements IStrategy {
	Board boardCopy;
    BoardEvaluatorImpl boardEvaluator;
    int depth = 3; // new feature if we change depth to represent a computer difficulty (not sure what design pattern it fits as though).
    ...
    public Move getMove(Board board) {
        ...
        double bestScore = boardCopy.getTurn().equals(Type.MUSKETEER) ? Integer.MIN_VALUE : Integer.MAX_VALUE;
